...
export PATH=/opt/nvim/nvim-linux64/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/games:/usr/games:/home/abr4hack/.fzf/bin
...
source /home/abr4hack/powerlevel10k/powerlevel10k.zsh-theme
...
# Which system
  function whichSystem(){
    if [ $# -eq 1 ]; then
    python3 /opt/whichSystem.py $1
    else 
    echo '[!] Uso: whichSystem <direccion-ip>'
    fi
}